...
<%--                        <a class="dropdown-item" href="${pageContext.request.contextPath}/products?action=displayShirt">Áo</a>--%>
                ...
                <div class="card-body">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <a class="btn btn-primary" href="${pageContext.request.contextPath}/products?action=edit&code=${product.code}" style="width: 90px">Edit</a>

                            <a class="btn btn-primary" href="${pageContext.request.contextPath}/products?action=delete&code=${product.code}" style="width: 90px">Delete</a>
