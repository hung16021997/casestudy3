...
<header class="container">
    <nav class="navbar navbar-expand-md bg-white navbar-white fixed-top">
        <a class="nav-link navbar-brand" href="/products"><img height="50" src="https://startuanit.net/wp-content/uploads/cau-lac-bo-bong-da-Manchester-United-FC-40.jpg"
                                                               width="145"/></a>
...
<%--                        <a class="dropdown-item" href="#">Quần Nữ</a>--%>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="#">Câu lạc bộ </a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/order?action=cart">
                                    Cart</a>
<%--                                <a class="dropdown-item">Create Product</a>--%>
                                <a class="dropdown-item" href="logout">Logout</a>
